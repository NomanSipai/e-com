                ...
                <Dialog.Panel className="pointer-events-auto w-screen max-w-md">
                  <div className="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                                  ...
                                  <div className="ml-4 flex flex-1 flex-col">
                                    <div>
                                      <div className="flex justify-between text-base font-medium text-gray-900">
                                        ...
                                        <p className="ml-4 text-red-600 ">{`$${priceCal.toFixed(
                                          2
                                        )}`}</p>
                                      </div>
                                    ...
                                    <div className="flex flex-1 items-end justify-between text-sm">
                                      <p className="text-gray-500 mb-3">Qty</p>
                                      <p>
                                        <button
                                        ...
                                        <input
                                          type="text"
                                          className=" border-2 border-indigo-600 w-20 rounded text-center text-black font-bold "
                                          readOnly
                    ...
                    <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
                      <div className="flex justify-between text-base font-medium text-gray-900">
                        <p>Subtotal</p>
                        <p className="text-red-500">${subTotal.toFixed(2)}</p>
                      </div>
